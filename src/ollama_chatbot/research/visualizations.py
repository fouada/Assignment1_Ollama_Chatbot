...
class ResearchVisualizer:
    ...
    def __init__(self):
        ...
        self.model_colors = {"llama3.2": "#1f77b4", "mistral": "#ff7f0e", "phi3": "#2ca02c", "codellama": "#d62728"}
    ...
    def create_sensitivity_chart(self, data: Dict[str, Any], metric: str = "quality") -> go.Figure:
        """
    ...
    def create_model_comparison_chart(self, data: Dict[str, Any], metric: str = "composite_score") -> go.Figure:
        """
    ...
    def create_latency_distribution_chart(self, data: Dict[str, Any], model: Optional[str] = None) -> go.Figure:
        """
    ...
    def create_percentile_chart(self, data: Dict[str, Any]) -> go.Figure:
        """
    ...
    def create_quality_radar_chart(self, data: Dict[str, Any]) -> go.Figure:
        """
    ...
    def create_comparison_heatmap(self, data: Dict[str, Any]) -> go.Figure:
        """
        ...
        fig.update_layout(
            title="Statistical Comparison Heatmap (p-values)", template="plotly_white", height=400, showlegend=False
        )

        return fig

    def create_performance_overview_dashboard(
        self, sensitivity_data: Dict[str, Any], comparison_data: Dict[str, Any], latency_data: Dict[str, Any]
    ) -> go.Figure:
        """
        ...
        fig = make_subplots(
            rows=2,
            cols=2,
            subplot_titles=("Temperature Sensitivity", "Model Rankings", "Latency Distribution", "Quality by Category"),
            specs=[[{"type": "scatter"}, {"type": "bar"}], [{"type": "box"}, {"type": "bar"}]],
        )
        ...
        if "overall_rankings" in comparison_data:
            ...
            fig.add_trace(go.Bar(x=models, y=scores, marker_color=colors, name="Score", showlegend=False), row=1, col=2)
        ...
        fig.update_layout(
            title="Research Performance Overview Dashboard", template="plotly_white", height=800, showlegend=True
        )
    ...
    def create_correlation_matrix(self, data: Dict[str, Any]) -> go.Figure:
        ...
        fig.update_layout(title="Correlation Matrix", template="plotly_white", height=500)

        return fig

    def create_streaming_comparison_chart(self, data: Dict[str, Any]) -> go.Figure:
        """
        ...
        streaming = [data["streaming"]["mean_response_time"], data["streaming"].get("mean_first_token_latency", 0) or 0]
    ...
    def _create_empty_chart(self, message: str) -> go.Figure:
        ...
        fig.update_layout(template="plotly_white", height=400, xaxis=dict(visible=False), yaxis=dict(visible=False))
